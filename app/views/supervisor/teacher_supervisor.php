        ...
        <div class="row">
            <div class="col s12">
                ...
                <div class="right-align">
                    <a class="btn light-green modal-trigger" href="#modal01">Agregar Docente</a>
                </div>
                <!-- Modal Structure -->
                <div id="modal01" class="modal">
                    <div class="modal-content">
                        <h4>Agregar Docente</h4>
                        <form action="<?= RUTA_URL ?>/supervisor/add_teacher" method="POST">
                    ...
                    <?php 
                            ...
                            ?>
                                ...
                                <div id="modal_view<?= $key->id_person ?>" class="modal">
                                    <div class="modal-content">
                                        <h4>Visualizar Docente <b><?= $key->name_person." ".$key->last_name_person ?></b></h4>
                                        <p>
                                    ...
                                    <hr>
                                    <div class="modal-footer">
                                        <a class="btn red accent-3 btn-delete" href="<?= RUTA_URL ?>/supervisor/delete_teacher/id/<?= $key->id_person ?>">Eliminar Docente</a>
                                        <a href="#!" class="modal-close waves-effect waves-green btn-flat">Cerrar</a>
                                    </div>
                                </div>
                                <!-- Modal Structure -->
                                <div id="modal_update<?= $key->id_person ?>" class="modal">
                                    <div class="modal-content">
                                        <h4>Modificar Docente <b><?= $key->name_person." ".$key->last_name_person ?></b></h4>
                                        <form action="<?= RUTA_URL ?>/supervisor/update_teacher/id/<?= $key->id_person ?>" method="POST">
                                            <div class="input-field col s12">
